...
<div class="col-1">
    ...
    <div id="pampers_Checkbox1">
        ...
        ])->checkbox([ 'value' => 'New Baby- Dry', 'class' => 'checkbox', 'id' => 'Checkbox1', 'label' => null])->label(false) ?>
...
<!--            Sale</label>-->
    ...
    <label for="Checkbox1" id="Label1">New Baby- Dry</label>
    <hr id="Line4">
    <div id="pampers_Checkbox2">
        <?php  echo $form->field($searchModel, 'view2',[
            'template' => '{input}<label for="Checkbox2"></label>',
        ])->checkbox([ 'value' => 'Active Baby -Dry', 'class' => 'checkbox', 'id' => 'Checkbox2', 'label' => null])->label(false) ?>
    </div>
    <label for="Checkbox2" id="Label2">Active Baby -Dry</label>
    <hr id="Line3">
    <div id="pampers_Checkbox3">
        <?php  echo $form->field($searchModel, 'view3',[
            'template' => '{input}<label for="Checkbox3"></label>',
        ])->checkbox(['value' => 'Premium Care', 'class' => 'checkbox', 'id' => 'Checkbox3', 'label' => null])->label(false) ?>
    </div>
    <label for="Checkbox3" id="Label3">Premium Care</label>
    <hr id="Line5">
    <div id="pampers_Checkbox10">
        <input type="checkbox" id="Checkbox10" name="Checkbox1" value="on"><label for="Checkbox10"></label>
    </div>
    <label for="Checkbox3" id="Label10">Sleep and Play</label>
